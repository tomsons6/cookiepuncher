...
namespace BNG
{
    ...
    public class UIPointer : MonoBehaviour
    {
        ...
        void AttachPointers()
        {
            ...
            //if (GameManager.Instance.m_IsMultiplayer)
            //{
            //    Debug.Log("Gamemanager found");
            //    if (this.transform.root.name == "VRIK_PUN_Player (Local)")
            //    {
            //        Debug.Log("Čist īstais");
